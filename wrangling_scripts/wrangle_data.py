...
# TODO: Scroll down tol ine 157 and set up a fifth vizualization for the data dashboard
...
def cleandata(dataset, keepcolumns = ['Country Name', '1990', '2015'], value_variables = ['1990','2015']):
    ...
    Keeps data range of dates in keep_columns variable and data for the top 10 economics.
    Changes the columns into a year, country and value
...
def return_figures():
    """Creates four plotly visuals

    Args:
        None
    
    Returns:
        lists (dict): list containing the four plolty visualizations

    """
# first chart plots arable land form 1990 to 2016 in top 10 economies
    graph_one =[]
    ...
    layout_one = dict(title = 'Hectares Arable Land per Person by top 10 countries',
